...
set REQUIREMENTS=requirements-labelimg.txt
...
echo [1mCreate linked virtual environment folder at '%VENV%-%PYTHON_VERSION%'...[0m
md "%VENV%-%PYTHON_VERSION%"
echo [1mCreate symbolic link to linked virtual environment folder...[0m
